...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_PABase_t, stringdata) + ofs \
...
const QMetaObject PABase::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_PABase.data,
      qt_meta_data_PABase,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PABase.stringdata))
