...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_PAPortName_t, stringdata) + ofs \
...
const QMetaObject PAPortName::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_PAPortName.data,
      qt_meta_data_PAPortName,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PAPortName.stringdata))
